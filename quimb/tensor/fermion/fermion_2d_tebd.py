...
def Hubbard2D(t, u, Lx, Ly, mu=0., symmetry=None, flat=True, spinless=False):
    ...
    for i, j in product(range(Lx), range(Ly)):
        ...
        if i+1 != Lx:
            ...
            uop = Hubbard(t,u, mu, (1./count_ij, 1./count_b), symmetry=symmetry, flat=flat, spinless=spinless)
            ham[where] = uop
        if j+1 != Ly:
            where = ((i,j), (i,j+1))
            ...
            uop = Hubbard(t,u, mu, (1./count_ij, 1./count_b), symmetry=symmetry, flat=flat, spinless=spinless)
            ham[where] = uop
    return LocalHam2D(Lx, Ly, ham, spinless=spinless)
...
class LocalHam2D(LocalHamGen):
    ...
    def __init__(self, Lx, Ly, H2, H1=None, spinless=False):
        self.Lx = int(Lx)
        self.Ly = int(Ly)
        ...
        super().__init__(H2=H2, H1=H1, spinless=spinless)
